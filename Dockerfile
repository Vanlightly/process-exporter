...
WORKDIR /go/src/github.com/vanlightly/process-exporter
ADD . .
#RUN dep ensure
...
COPY --from=build /go/src/github.com/vanlightly/process-exporter/process-exporter /bin/process-exporter
